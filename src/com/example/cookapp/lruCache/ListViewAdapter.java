...
import com.example.cookapp.lruCache.GridViewAdapter.DownloadBitmapAsyncTask;
import com.example.cookapp.lruCache.GridViewAdapter.ScrollListenerImpl;
import com.example.cookapp.lruCache.GridViewAdapter.ViewHolder;

@SuppressLint("NewApi")
public class ListViewAdapter extends ArrayAdapter<AllFoodEntity>{
	...
	public ListViewAdapter(Context context, int textViewResourceId,List<AllFoodEntity> objects, ListView listview) {
        super(context, textViewResourceId, objects);
        this.listview=listview;
        listview.setOnScrollListener(new ScrollListenerImpl(objects));
